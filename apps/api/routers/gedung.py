...
from apps.api.utils.geo import haversine_distance, get_bounding_box
from apps.api.schemas.gedung import NearbyRequest, NearbyResponse, GedungDetailSchema
from apps.api.schemas.common import ErrorResponse

router = Router()


@router.post("/nearby", response={200: NearbyResponse, 400: ErrorResponse}, tags=["Gedung"])
...
@router.get("/{gedung_uuid}", response={200: GedungDetailSchema, 404: ErrorResponse}, tags=["Gedung"])
